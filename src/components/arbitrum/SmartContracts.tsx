...
const DrawMethod: React.FunctionComponent<InterfaceDrawMethodProps> = (props) => {
  ...
  const { dapp, account, /* setBusy, */ abi, address, client, web3 } = props;
...
const ContractCard: React.FunctionComponent<{
  ...
  client: any;
  web3: Web3 | undefined;
}> = ({ dapp, account, contract, index, remove, client, web3 }) => {
      ...
      <Card className="mb-2">
        <Card.Header className="px-2 py-1">
          ...
          <Button
            ...
            variant="link"
            onClick={async () => {
              const chainId = await dapp.request('ethereum', {
                method: 'eth_chainId',
                params: [],
              });
